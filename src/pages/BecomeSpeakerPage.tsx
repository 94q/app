...
const WEBHOOK_URL = import.meta.env.VITE_DISCORD_SPEAKER_WEBHOOK as string | undefined;
...
const fields: FieldConfig[] = [
  ...
  },
  {
    ...
    label: 'Current Occupation / Professional Role',
    type: 'text',
  ...
  },
  {
    ...
    label: 'Previous Public Speaking Experience',
    type: 'textarea',
    placeholder: 'Events, talks, panels, or none',
  },
  {
    id: 'talkDescription',
    label: 'Talk Description',
    type: 'textarea',
    placeholder: 'What would your talk be about?',
    required: true,
  },
  {
    id: 'socialMediaLinks',
  ...
  },
  {
    ...
    label: 'Company Links',
    type: 'textarea',
    placeholder: 'Company website or portfolio',
  },
];
...
export const BecomeSpeakerPage: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!WEBHOOK_URL) {
      setIsError(true);
      setStatusMessage(
        'Submission is not configured yet. Please set VITE_DISCORD_SPEAKER_WEBHOOK.'
      );
      return;
    }
    ...
    const payload = {
      username: 'TEDx Speaker Form',
      embeds: [
        {
          title: 'Become a Speaker Submission',
          color: 0x7c3aed,
          fields: embedFields,
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black section-padding pt-32">
      ...
      <div className="container-custom relative z-10 w-full">
        ...
        >
          ...
          >
            Tell us about yourself and your idea. We read every submission.
          </motion.p>
...
export default BecomeSpeakerPage;
